...
const DiamondOne = () => {
  ...
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={setWith} height={setHeight} viewBox='0 0 1938 2178'>
      <defs>
        ...
        <filter id='Union_1' x='270' y='0' width='1668' height='2178' filterUnits='userSpaceOnUse'>
          <feOffset dy='3' input='SourceAlpha' />
